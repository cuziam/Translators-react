...
![이미지 설명](readme_images/architecture1.jpg)

### *중요: 2024/10/21부터 AWS를 활용한 서버리스 아키텍쳐로 전환을 시작합니다.
11월 4일부터 비용 책정, 파일구조, 코드, 형상관리 방식 등이 대폭 변경될 예정이며, AWS Amplify로 서버리스 아키텍쳐를 구현할 예정입니다.

### <아키텍쳐 계획>  
![이미지 설명](readme_images/architecture2.jpg)
